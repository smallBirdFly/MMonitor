...
define('VPASS_CLIENT', realpath(__DIR__ ) );

require_once VPASS_CLIENT . '/Lib/Thrift/ClassLoader/ThriftClassLoader.php';
require_once VPASS_CLIENT . '/AddressManager.php';

$loader = new \Thrift\ClassLoader\ThriftClassLoader();
$loader->registerNamespace('Thrift', VPASS_CLIENT. '/Lib');
...
class vpassClient
{
    ...
    public static function getServiceDir($service_name)
    {
        ...
        {
            $service_dir = VPASS_CLIENT . "/$service_name";
        }
        return $service_dir;
    }
}
...
class ThriftInstance
{
    ...
    protected function __instance()
    {
        ...
        $transport_name = vpassClient::getTransport($this->serviceName);
        $transport = new $transport_name($socket);
        // Protocol
        $protocol_name = vpassClient::getProtocol($this->serviceName);
        ...
        // 客户端类名称
        $class_name = "\\vpasscon\\" . $this->serviceName . "\\" . $this->serviceName . "Client";
        // 类不存在则尝试加载
    ...
    protected function includeFile()
    {
        ...
        $service_dir = vpassClient::getServiceDir($this->serviceName);
